...
class RoyalCaribbeanCruises extends Component {
  state = {
    cruises: [],
    name: " ",
    price: " ",
  ...
  componentDidMount() {
    this.loadRoyalCaribbeanCruises();
  }

  loadRoyalCaribbeanCruises = () => {
    API.getRoyalCaribbeanCruises()
      .then(res =>
...
export default RoyalCaribbeanCruises;
